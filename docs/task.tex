...
\begin{longtable}{|P{0.5\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
    ...
    Задача 3.5. Разработка системы мониторинга статусов мероприятий          & 6                  & 06.06.2026    &                     \\ \hline
...
\begin{tabularx}{\textwidth}{@{} P{0.45\textwidth} P{0.3\textwidth} P{0.25\textwidth} @{}}
    ...
    \centering \shortstack{\includegraphics[height=1.1cm]{images/подпись.png}\\\rule{3.5cm}{0.4pt}} \par \footnotesize (подпись) &
    \hfill К. Р. Крипак                                           \\
\end{tabularx}
}
